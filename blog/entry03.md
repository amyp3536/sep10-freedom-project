...
## Content
  Since my last blog entry, I was working on future technologys for my topic **Diagnostic medical sonography**. During this process, I wanted to create ideas that were revolutianary but still realistic enough to exist in the future. How I came up with these ideas, I first started thinking what conflicts sonpgraphers go through like limited visability, or even the accuracy of images and so I created technologys based on that. 
